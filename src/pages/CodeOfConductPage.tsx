...
const CodeOfConductPage: React.FC = () => {
    ...
    const title = document ? (language === 'id' ? document.title_id : document.title_en) : (language === 'id' ? 'Kode Etik' : 'Code of Conduct');
    ...
    return (
        <div className="min-h-screen bg-slate-50">
            <Header activeSection="ethics" onNavigate={handleNavigate} />
                ...
                <div className="container mx-auto px-6 py-20">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="bg-white rounded-[2rem] shadow-xl border border-slate-100 p-6 sm:p-12 mb-8 relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-purple-50/50 rounded-bl-[10rem] -z-0"></div>
                            <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-6 mb-8">
                                <div className="w-20 h-20 bg-gradient-to-br from-purple-600 to-pink-500 rounded-3xl flex items-center justify-center shadow-lg shadow-purple-500/20">
                        ...
                        {/* Footer Note */}
                        <div className="mt-8 p-8 bg-gradient-to-br from-purple-50 to-white border border-purple-100 rounded-[2rem] shadow-sm">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-600 font-bold leading-relaxed">
                                        ...
                                        <a href="mailto:ethics@pentavalent.com" className="text-purple-600 font-black hover:underline decoration-2 underline-offset-2">
