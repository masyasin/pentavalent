          ...
          <div className="p-6 sm:p-8">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-4">
                ...
                <div className="group">
                  <label htmlFor="password" className="block text-[10px] font-black text-blue-200/50 uppercase tracking-[0.2em] mb-1.5 ml-1">
                    Security Credential
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-xl pl-12 pr-12 py-3 text-white font-bold placeholder:text-blue-300/20 focus:outline-none focus:ring-4 focus:ring-accent/20 focus:border-accent/50 transition-all text-sm"
                      placeholder="••••••••"
                    />
                    <button
                      type="button"
                ...
                {/* Styled Math Captcha */}
                <div className="bg-white/5 rounded-2xl p-4 border border-white/5 relative group/captcha">
                  <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
                    <div className="flex-shrink-0 text-center sm:text-left">
                      <p className="text-[9px] font-black text-accent uppercase tracking-[0.3em] mb-2">Verification</p>
                      <div className="flex items-center justify-center sm:justify-start gap-3">
                        <div className="text-xl font-black text-white tracking-tighter tabular-nums bg-white/5 px-4 py-2 rounded-xl border border-white/10 ring-2 ring-white/5">
                          {captcha.n1} <span className="text-accent">+</span> {captcha.n2}
                        </div>
                        <button
                          type="button"
                          onClick={generateCaptcha}
                          className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center hover:bg-accent hover:text-white transition-all text-blue-300 border border-white/10"
                        >
                    ...
                    <div className="flex-1 w-full relative">
                      <label htmlFor="captcha" className="block text-[9px] font-black text-blue-200/50 uppercase tracking-[0.2em] mb-1.5">Result</label>
                      <input
                        id="captcha"
                        type="number"
                        required
                        ...
                        className="w-full bg-white/10 border-2 border-white/10 rounded-xl px-4 py-2 text-white font-black text-xl placeholder:text-white/10 focus:outline-none focus:border-accent focus:ring-4 focus:ring-accent/10 transition-all text-center sm:text-left h-[42px]"
                        placeholder="?"
                      />
                    </div>
                  </div>
