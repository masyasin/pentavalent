...
import { AlertTriangle, Trash2, X, CheckCircle2, Info, Save } from 'lucide-react';
                        ...
                        <div className="p-8 md:p-10">
                            ...
                            <div className="flex justify-center mb-8">
                                <div className="relative">
                                    <div className={`w-24 h-24 rounded-[2rem] ${theme.bg} flex items-center justify-center ${theme.text} animate-pulse`}>
                                        <Icon size={40} />
                                    </div>
                                    <div className={`absolute -top-2 -right-2 w-10 h-10 rounded-2xl bg-white shadow-xl border ${theme.border} flex items-center justify-center ${theme.text}`}>
                                        <Info size={20} />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    {itemName && (
                                        <div className="inline-block px-4 py-2 bg-gray-50 border border-gray-100 rounded-xl">
                                            ...
                                            <p className={`font-bold tracking-tight ${theme.text}`}>{itemName}</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 mt-10">
                                ...
                                <button
                                    ...
                                    disabled={isLoading}
                                    className={`flex-[1.5] px-8 py-4 ${theme.primary} text-white font-bold rounded-2xl ${theme.primaryHover} transition-all shadow-xl ${theme.shadow} flex items-center justify-center gap-2 uppercase tracking-widest text-[10px] active:scale-95 disabled:opacity-50 group`}
                                >
                                    {isLoading ? (
