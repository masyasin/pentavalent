      ...
      <div className="max-w-[1700px] mx-auto px-8 md:px-12 lg:px-16 relative z-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
          {management.map((person) => (
            <div
              key={person.id}
              className="group bg-white rounded-[3rem] overflow-hidden border border-gray-100 enterprise-shadow transition-all duration-700 hover:-translate-y-4 hover:shadow-2xl hover:shadow-primary/10 relative"
            >
              <div className="relative aspect-[4/5] overflow-hidden bg-slate-100 group/img">
                {/* Background Floating Decor */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-cyan-400/20 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-all duration-1000 group-hover:scale-[3]"></div>
                ...
                <div className="absolute inset-x-0 bottom-0 p-10 transform translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-700 cubic-bezier(0.16, 1, 0.3, 1) delay-100">
                  <div className="w-8 h-[2px] bg-cyan-500 mb-4"></div>
              ...
              <div className="p-10 text-center relative bg-white">
                ...
                <div className="mb-4">
                  <h4 className="text-2xl font-black text-slate-900 group-hover:text-cyan-600 transition-colors duration-500 tracking-tighter uppercase leading-none">
                    {person.name}
                  </h4>
                </div>
                ...
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span className="text-cyan-500 text-[10px] font-black uppercase tracking-[0.25em] whitespace-nowrap">
        ...
        <div className="mt-32 p-12 bg-white rounded-[3.5rem] border border-gray-100 enterprise-shadow text-center relative overflow-hidden group">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex gap-4">
              <div className="w-16 h-16 bg-gray-50 rounded-2xl flex items-center justify-center text-primary/20 group-hover:text-accent transition-colors">
