        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="lg:w-[40%] flex-shrink-0">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-5xl xl:text-[56px] font-black py-2 mb-10 text-slate-900 tracking-tighter leading-[1.05]">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-cyan-500 to-emerald-400 italic inline-block pr-4">{t('qa.subtitle')?.split(' ').slice(1).join(' ')}</span>
            </h2>
          ...
          <div className="lg:w-[60%] grid sm:grid-cols-2 gap-8">
            {loading ? (
              [...Array(4)].map((_, i) => (
