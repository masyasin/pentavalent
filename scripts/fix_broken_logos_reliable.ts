...
const allPartners = [
    // INTERNATIONAL - Using Clearbit and reliable Wikimedia SVG links
    {
    ...
    // PRINCIPALS - Using local paths and verifying they exist
    {
    ...
    },
    {
        ...
        partner_type: 'principal',
        logo_url: 'https://logo.clearbit.com/kalbe.co.id',
    ...
    },
    {
        ...
        partner_type: 'principal',
        logo_url: 'https://logo.clearbit.com/kimiafarma.co.id',
        website: 'https://www.kimiafarma.co.id',
        description_id: 'BUMN farmasi terkemuka.',
        description_en: 'Leading state-owned pharmaceutical.',
        sort_order: 18
    },
    {
        name: 'PT Dexa Medica',
        partner_type: 'principal',
        logo_url: 'https://logo.clearbit.com/dexa-medica.com',
        website: 'https://www.dexa-medica.com',
        description_id: 'Farmasi berkualitas tinggi.',
        description_en: 'High-quality pharmaceutical company.',
        sort_order: 19
    }
];

async function updateLogosReliable() {
    console.log('🚀 Using reliable Clearbit & Local Paths to fix broken images...');
    ...
    if (error) {
        ...
        console.log(`✅ Successfully updated ${allPartners.length} partners with reliable links!`);
    }
}
